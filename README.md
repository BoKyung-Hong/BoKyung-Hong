...
#### 🔹 결제 시스템 안정화
- TossPayments API 연동
- 외부 응답값 검증 및 예외 케이스 처리
- 트랜잭션 관리로 데이터 일관성 유지

#### 🔹 FIFO 포인트 시스템 설계
- 단순 차감이 아닌 **만료일 + 상태값 기반 구조 설계**
- 선입선출 로직 직접 구현
- 확장 가능성을 고려한 엔티티 구조 설계

#### 🔹 동시성 제어
- 동시 결제 상황에서 발생하는 데이터 충돌 해결
- 비관적 락 적용으로 정합성 확보

#### 🔹 배치 자동화
- Spring Scheduler 기반 멤버십 만료 자동 처리
...
## 📫 Contact
- **Email**: hbk491@hanmail.net
- **Notion (학습 기록)**: [Backend Study Daily log](https://www.notion.so/Backend-Study-Daily-log-268bc07a4cf0806fb8f5d82095c1dc0a)
